...
echo '<p>';
esc_html_e( 'Would you like to boost your website sharing abilities?', 'iworks-pwa' );
echo '</p>';
echo '<p>';
printf(
	/* translators: %s is a plugin name with url */
	esc_html__( 'Don\'t wait, install plugin %s!', 'iworks-pwa' ),
...
"><?php echo esc_html( __( 'Install', 'iworks-pwa' ) ); ?></a></p>
